...
const envConfig = {};
if (process.env.FOUNDRY_USERNAME)
  envConfig.foundryUsername = process.env.FOUNDRY_USERNAME;
if (process.env.FOUNDRY_PASSWORD)
  envConfig.foundryPassword = process.env.FOUNDRY_PASSWORD;

const argvConfig = process.argv
